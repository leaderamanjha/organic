package com.amankumarsapplication.app.modules.otpverification.ui
...
import com.amankumarsapplication.app.databinding.ActivityOtpVerificationBinding
import com.amankumarsapplication.app.modules.otpverification.`data`.viewmodel.OtpVerificationVM
  ...
  ActivityResultCallback {
    ...
    companion object {
      ...
      fun getIntent(context: Context, bundle: Bundle?): Intent {
        val destIntent = Intent(context, OtpVerificationActivity::class.java)
